...
from modules import MSE_Loss, PearsonCorr, SpearmanCorr, FactorVAE
...
class FactorVAEEvaluator:
    ...
    def load_configs(self, config_file:str):
        ...
        self.model_preparer.set_configs(feature_size=eval_configs["Model"]["feature_size"],
    ...
    def load_args(self, args:argparse.Namespace | argparse.ArgumentParser):
        ...
        self.model_preparer.set_configs(feature_size=args.feature_size,
