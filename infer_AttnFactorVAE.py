...
class AttnFactorVAEInfer:
    ...
    def infer(self):
        ...
        with torch.no_grad(): 
            for batch, (quantity_price_feature, fundamental_feature, label, valid_indices) in enumerate(tqdm(self.test_loader, desc="Infer")):
...
def parse_args():
    parser = argparse.ArgumentParser(description="AttnFactorVAE Inference")
